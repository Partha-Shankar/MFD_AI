    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mt-2">Sign in to continue to MFD AI platform</p>
        </div>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all"
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-gray-700 ml-1 flex justify-between">
                Password
                <Link to="/" className="text-primary-600 hover:text-primary-700 font-medium">Forgot?</Link>
              </label>
              <div className="relative">
          ...
          <div className="mt-8 pt-8 border-t border-gray-50 text-center">
            <p className="text-gray-500">
              ...
              <Link to="/signup" className="text-primary-600 font-bold hover:underline">Create one for free</Link>
            </p>
          </div>
        </div>
      </motion.div>
