...
const VIDEO_STAGES: Stage[] = [
  { agent: 'System Core', message: 'Initializing multi-agent forensic pipeline...' },
  { agent: 'Orchestrator', message: 'Allocating resources for video analysis...' },
  { agent: 'Media Parser', message: 'Extracting metadata and decoding video stream...' },
  { agent: 'Frame Engine', message: 'Sampling keyframes at adaptive intervals...' },
  { agent: 'Vision AI', message: 'Running frame-level authenticity classification...' },
  { agent: 'Frame Analyzer', message: 'Detecting spatial inconsistencies in frame batch...' },
  { agent: 'GAN Detector', message: 'Scanning for generative model fingerprints...' },
  { agent: 'Texture Engine', message: 'Evaluating surface-level texture realism...' },
  { agent: 'Edge Inspector', message: 'Checking structural boundary coherence...' },
  { agent: 'Temporal Agent', message: 'Analyzing frame-to-frame transitions...' },
  { agent: 'Motion Tracker', message: 'Computing optical flow consistency...' },
  { agent: 'Dynamics Engine', message: 'Evaluating motion smoothness and jitter patterns...' },
  { agent: 'Pose Analyzer', message: 'Tracking head pose stability across frames...' },
  { agent: 'Interpolation Detector', message: 'Checking for synthetic frame generation...' },
  { agent: 'Signal Processor', message: 'Performing frequency domain decomposition...' },
  { agent: 'FFT Analyzer', message: 'Detecting spectral anomalies...' },
  { agent: 'Noise Model', message: 'Comparing sensor noise distribution...' },
  { agent: 'Compression Inspector', message: 'Analyzing encoding artifacts...' },
  { agent: 'Semantic AI', message: 'Validating scene coherence...' },
  { agent: 'Context Engine', message: 'Checking object relationships...' },
  { agent: 'Physics Validator', message: 'Evaluating lighting and shadow consistency...' },
  { agent: 'Reality Checker', message: 'Detecting logical inconsistencies...' },
  { agent: 'Biometric Agent', message: 'Evaluating blink patterns and facial dynamics...' },
  { agent: 'Micro-Expression Engine', message: 'Analyzing subtle emotional variations...' },
  { agent: 'Depth Analyzer', message: 'Estimating scene depth consistency...' },
  { agent: 'Reflection Inspector', message: 'Checking eye and surface reflections...' },
  { agent: 'Photometric Engine', message: 'Validating illumination uniformity...' },
  { agent: 'Consensus Engine', message: 'Aggregating multi-layer forensic signals...' },
  { agent: 'Confidence Model', message: 'Resolving conflicting indicators...' },
  { agent: 'Anomaly Detector', message: 'Ranking detected irregularities...' },
  { agent: 'Decision Engine', message: 'Computing final authenticity score...' },
  { agent: 'Report Generator', message: 'Constructing explainable forensic report...' },
  { agent: 'Explainability Engine', message: 'Translating signals into human-readable insights...' },
  { agent: 'UI Formatter', message: 'Preparing visualization payload...' },
  { agent: 'System Core', message: 'Analysis complete.' }
];
